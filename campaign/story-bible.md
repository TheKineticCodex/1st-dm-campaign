...
The **Lantern Carnival** sails the Twilight Sea between worlds. It exists
because of that first bargain: the Court lets it float in exchange for a
tithe — the carnival unknowingly *ferries* the Court's purchases. Every game
prize, every fortune told, skims something small. Every eight years it
docks in the mortal world to collect.

**The flaw in the first bargain** (the campaign's win condition, revealed in
Act 3): the Sea could not lawfully sell its song, because the song was never
the Sea's alone — every creature born of the Sea holds a note of it.
**Peaches holds one.** A contract missing a signatory can be voided… if all
...
1. **The Gate of Paper Lanterns** — arrival; the Twins take one honest answer each (ask every player at the table, out loud; write them in the Book).
2. **The Games of the Midway** — run the **Snail Derby** on the phones. Prizes: a paper crown that never tears, bottled applause… and Billy gets *a page in his mentor's handwriting*.
3. **Grandmother Grey-Gill's Tent** — in-fiction divination; quote their real quiz answers back as prophecy (✉✦ buttons). Grey-Gill won't name who buys lost things.
4. **The Missing Note** — the carousel skips one note, every round. It's in Peaches' key. Hum the note and the carnival *leans in*.
5. **Whispers in the Dark** — sealed whisper to each phone: their Lost Thing, glimpsed. (Peaches: wet footprints ending mid-stride. Billy: ink drying on a page no hand writes.)
6. **The Three Gates** — midnight; the back fence opens three ways. *Let them choose.* Every road is prepared:
   - 🟢 **Bog Gate** → the Drowned Bog (Old Cassia, jarred voices)
   - 🪞 **Mirror Gate** → the Hall of Facets (the Curator; Billy's road)
   - 🔵 **Gate Below** → the Under-Sea (the drowned market; Peaches' road)

Whichever they take, the other two gates "remember being chosen last" — the
unchosen roads grow stranger and will be there in later sessions.
...
- Every bargain anyone strikes goes through the **app's contract quill** — the campaign's theme *is* the app's killer feature.
- Milestone leveling: end of Act 1 → level 2; mid-Act 2 → level 3 *(confirm the VERIFY-flagged level-2 data before then)*.
- Philip + player 4: the moment their quizzes land, write their row in the table above and thread their Lost Thing into whichever Act 2 road they'd chase.
